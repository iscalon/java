...
@Component
public class NeuralNetworkDiffTraining {

  private static final Logger LOGGER = LoggerFactory.getLogger(NeuralNetworkDiffTraining.class);
